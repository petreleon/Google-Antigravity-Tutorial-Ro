...
Acest tutorial este structurat în module simple, gândite pentru **începători absoluți**. Nu ai nevoie de cunoștințe anterioare.

Iată traseul nostru:

1.  **[Modulul 1: Bazele Git - Salvarea muncii tale](./01_git_basics.md)**
    *   Vom învăța cum să păstrăm istoricul modificărilor tale ca într-un joc video (save points).
